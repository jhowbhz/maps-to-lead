  ...
  router.get('/manager/api/leads.xlsx', requireToken, async (_req, res) => {
    try {
      ...
      ws.columns = [
        ...
        { header: 'Endereço', key: 'address', width: 44 },
        { header: 'Nota', key: 'rating', width: 8 },
        { header: 'Avaliações', key: 'reviews', width: 12 },
        { header: 'Score', key: 'score', width: 8 },
        { header: 'Tier', key: 'tier', width: 6 },
        { header: 'Site visitado', key: 'siteVisitado', width: 13 },
        { header: 'Campos extra', key: 'camposEncontrados', width: 20 },
      ...
      for (const l of leads) {
        ws.addRow({
          name: l.name, phone: l.phone, whatsapp: l.whatsapp, ddd: l.ddd, email: l.email,
          instagram: l.instagram, facebook: l.facebook, website: l.website,
          street: l.street, number: l.number, neighborhood: l.neighborhood,
          city: l.city, uf: l.uf, cep: l.cep, address: l.address,
          rating: l.rating, reviews: l.reviews, score: l.score, tier: l.tier,
          siteVisitado: l.siteVisitado ? 'sim' : 'não',
          camposEncontrados: l.camposEncontrados.join(', '),
